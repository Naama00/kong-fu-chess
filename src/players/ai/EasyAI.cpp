// players/ai/EasyAI.cpp
#include "players/ai/EasyAI.hpp"

namespace kungfu {

EasyAI::EasyAI(PlayerColor playerColor, std::mt19937::result_type seed)
    : playerColor_(playerColor), rng_(seed) {}

std::vector<ActionRequest> EasyAI::decideActions(const view::GameSnapshot& snapshot) {
